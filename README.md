...
- **Style** : minimaliste, rapide, inspiré de [Zed](https://zed.dev)
- **Palette** :
...
Code source dans [`/main`](./main).

## Statut

Objectif : sortir une v1 de l'éditeur en 1 mois, avec une vidéo de présentation YouTube.
