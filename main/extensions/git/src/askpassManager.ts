 ...
 * like GIT_ASKPASS point to scripts inside the HappyDev installation directory, which
...
/**
 * Checks if the current HappyDev installation is a Windows user or system setup.
 ...
 * This prevents accumulation of old versions when HappyDev updates.
 */
