...
declare namespace Fig {
	...
	interface Generator {
		...
		script?:
		| string[]
		| Function<string[], string[] | undefined> // <-- HappyDev edit to make results correct
		| ExecuteCommandInput
		 ...
		 *
		 */
		postProcess?: (out: string, tokens: string[]) => (Suggestion | null)[] | undefined; // <-- HappyDev edit to make results correct
		/**
		...
		) => Promise<(Suggestion | null)[] | undefined>; // <-- HappyDev edit to make results correct
		/**
		 *
