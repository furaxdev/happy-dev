...
/**
 * The main HappyDev application. There will only ever be one instance,
...
export class CodeApplication extends Disposable {
	...
	async startup(): Promise<void> {
		this.logService.debug('Starting HappyDev');
		...
		// "com.microsoft.", which breaks native tabs for HappyDev when using this
