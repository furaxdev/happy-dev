...
export type RemoteAgentHostConnectionStatus =
	...
	| {
		 ...
		 * Set only when the server was spawned by a HappyDev CLI willing
...
export interface IRemoteAgentHostSSHConnection {
	 ...
	 * client connects to, and is used to construct the HappyDev Remote
...
export interface IRemoteAgentHostTunnelConnection {
	 ...
	 * Used as the tunnel name in the HappyDev Remote Tunnels authority
