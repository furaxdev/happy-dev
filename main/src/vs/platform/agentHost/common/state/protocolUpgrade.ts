 ...
 * by the HappyDev CLI, asks the CLI to check for a server upgrade and
 ...
 * data payload. Servers that are spawned by the HappyDev CLI populate this
 ...
 * extension used by HappyDev-hosted agent hosts.
 *
