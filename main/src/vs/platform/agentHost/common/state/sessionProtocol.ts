...
// This file adds HappyDev-specific additions (ISetAuthTokenParams, ProtocolError)
...
/**
 * HappyDev-specific extension: set the auth token on the server.
