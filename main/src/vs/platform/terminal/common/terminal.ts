...
export interface IShellLaunchConfig {
	...
	/**
	 * Whether the terminal process environment will inherit HappyDev's "shell environment" that may
	 ...
	 * a terminal used to drive some HappyDev feature.
	 */
	isFeatureTerminal?: boolean;
	...
	tabActions?: ITerminalTabAction[];
	/**
	 * Report terminal's shell environment variables to HappyDev and extensions
	 */
...
export const enum ShellIntegrationStatus {
	...
	FinalTerm,
	/** HappyDev shell integration sequences have been encountered. Supercedes FinalTerm. */
	VSCode
}
