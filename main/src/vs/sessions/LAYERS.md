...
The sessions layer sits above `vs/workbench` in the HappyDev source code hierarchy. For the broader HappyDev layer rules (base → platform → editor → workbench → sessions), see `.github/instructions/source-code-organization.instructions.md`.
