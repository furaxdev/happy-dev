...
/**
 * Builds a redirect URL that GitHub will use to return the user to HappyDev
 ...
 * @param urlProtocol The HappyDev URL protocol scheme (e.g. `vscode`, `vscode-insiders`, `code-oss`).
