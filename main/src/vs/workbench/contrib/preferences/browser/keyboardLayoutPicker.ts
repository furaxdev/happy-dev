...
const DEFAULT_CONTENT: string = [
	`// ${nls.localize('displayLanguage', 'Defines the keyboard layout used in HappyDev in the browser environment.')}`,
	`// ${nls.localize('doc', 'Open HappyDev and run "Developer: Inspect Key Mappings (JSON)" from Command Palette.')}`,
	``,
