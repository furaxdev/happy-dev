 ...
 * - `IN_PRODUCT` - Content shown in HappyDev (both Stable and Insiders)
 * - `WEB` - Content shown on the website only
 * - `STABLE` - Content shown in HappyDev Stable only
 * - `INSIDERS` - Content shown in HappyDev Insiders only
 *
