...
/**
 * Allows webviews to monitor when an element in the HappyDev editor is being dragged/dropped.
 *
 * This is required since webview end up eating the drag event. HappyDev needs to see this
